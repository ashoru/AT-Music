...
AT Music is an open-source SwiftUI music player for iOS and iPadOS 26 and later. It brings several music platforms, local playlists, lyrics, downloads, NAS playback, and a highly configurable player into one native app.
...
```
ATMusic/
  ATMusicApp.swift              Application entry point
