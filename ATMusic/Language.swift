...
func atmusicLocalized(_ chinese: String, _ english: String) -> String {
    UserDefaults.standard.string(forKey: "atmusic.language") == AppLanguage.english.rawValue ? english : chinese
}

func atmusicPlatformName(_ provider: SearchProvider) -> String {
    switch provider {
    ...
    case .synology: return atmusicLocalized("群晖 NAS", "Synology NAS")
    }
}

func atmusicChartName(_ name: String) -> String {
    guard UserDefaults.standard.string(forKey: "atmusic.language") == AppLanguage.english.rawValue else { return name }
...
func atmusicChartSubtitle(_ subtitle: String) -> String {
    guard !subtitle.isEmpty else { return subtitle }
    guard UserDefaults.standard.string(forKey: "atmusic.language") == AppLanguage.english.rawValue else { return subtitle }
    let replacements: [(String, String)] = [
...
func atmusicLocalizedSettingValue(_ value: String) -> String {
    guard UserDefaults.standard.string(forKey: "atmusic.language") == AppLanguage.english.rawValue else { return value }
    switch value {
    case "关闭": return "Off"
    case "开启": return "On"
