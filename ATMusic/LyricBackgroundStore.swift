...
enum LyricBackgroundStore {
    static let pathKey = "atmusic.lyricBackground.image"
    static let dataKey = "atmusic.lyricBackground.data"
    static let blurKey = "atmusic.lyricBackground.blur"

    private static var directory: URL {
        let dir = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("ATMusicLyricBackground", isDirectory: true)
