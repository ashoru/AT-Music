...
struct KugouLoginSheet: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack(spacing: 18) {
                Capsule()
                    .fill(Color.atmusicComment.opacity(0.3))
                ...
                qrArea
                    ...
                    .padding(18)
                    .background { ATMusicSurface(shape: RoundedRectangle(cornerRadius: 30, style: .continuous)) }
    ...
    private var statusView: some View {
        ...
        .font(ATMusicFont.appFont(13))
        .foregroundStyle(isError ? Color.red.opacity(0.85) : Color.atmusicComment)
        .multilineTextAlignment(.center)
        .frame(height: 44)
    }
