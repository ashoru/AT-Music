...
final class SyncedPlaylistCache {
    ...
    private let playlistsKey = "atmusic.syncedPlaylistCache.playlists.v1"
    private let songsKey = "atmusic.syncedPlaylistCache.songs.v1"
    private let lock = NSLock()
    private let persistenceQueue = DispatchQueue(label: "AT Music.SyncedPlaylistCache.persistence", qos: .utility)
