...
enum FontManager {
    static let storedFontNameKey = "atmusic.globalFont"
    static let storedGreetingFontNameKey = "atmusic.homeGreetingFont"
    ...
    static func restoreFont(name: String, data: Data) -> Bool {
        clear()
        let file = fontsDirectory.appendingPathComponent("atmusic-restored-font.ttf")
        do {
