...
final class QQMusicAuth: ObservableObject {
    ...
    private let cookieKey = "atmusic.qqmusic.cookie.v1"
    private let nickKey = "atmusic.qqmusic.nickname.v1"
    private let vipKey = "atmusic.qqmusic.vip.v1"
    ...
    func importCookies(_ dict: [String: String], nickname: String?) {
        ...
        updatePublishedState {
            NotificationCenter.default.post(name: .atmusicQQLoginDidUpdate, object: nil)
        }
